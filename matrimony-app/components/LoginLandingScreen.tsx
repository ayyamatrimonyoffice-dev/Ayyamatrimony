...
const styles = StyleSheet.create({
  ...
  countryCodeText: { fontSize: 14, color: '#2A1010', fontFamily: fonts.interSemi },
  input: {
  ...
  registerLabel: { fontFamily: fonts.interSemi, fontSize: 13, letterSpacing: 0.3, color: '#FFFFFF' },
  loginRow: {
    flexDirection: 'row', alignItems: 'center', gap: 8, marginVertical: 2,
  },
